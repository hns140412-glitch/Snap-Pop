...
assert("flow-does-not-fallback-after-stale-null",!flow.includes("analyzeWritingMove(cur)||deps.refreshWritingMove(cur)")&&flow.includes("const move=await deps.analyzeWritingMove(cur);if(!move)return;"));
