...
for(const fn of ["renderRecords","renderGems","renderGrowth","renderGrowthTimeline","renderLastResult","updateStatus","openRecordEdit","renderWishHistory"]){assert("app-delegates-"+fn,app.includes("function "+fn)||app.includes("async function "+fn))}
