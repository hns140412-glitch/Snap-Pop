...
assert("badge-008-runtime-contract-verified-art-assets-open",byId["SP-BADGE-008"].coded===true&&byId["SP-BADGE-008"].staticVerified===true&&byId["SP-BADGE-008"].runtimeVerified===true&&byId["SP-BADGE-008"].deviceVerified===false&&/UNRESOLVED|OPEN/i.test(byId["SP-BADGE-008"].gap||""));
