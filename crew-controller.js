...
function normalizeIdentity(x={}){
  ...
  return {profile:{...IDENTITY_DEFAULT.profile,...p},crewMember:{...IDENTITY_DEFAULT.crewMember,...member,type},explorationCrewRulesVersion:deps.getRules()?.version||x.explorationCrewRulesVersion||"PENDING"};
}
