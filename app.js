const $=q=>document.querySelector(q), qa=q=>[...document.querySelectorAll(q)];
...
$("#settingsBtn").onclick=()=>show("settings");$("#settingsBack").onclick=()=>show(lastMain);qa("[data-back]").forEach(b=>b.onclick=()=>show(b.dataset.back));
